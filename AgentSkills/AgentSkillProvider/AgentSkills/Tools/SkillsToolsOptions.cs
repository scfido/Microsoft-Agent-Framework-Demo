...
public sealed class SkillsToolsOptions
{
    ...
    /// <summary>
    /// Creates options from a <see cref="SkillsOptions"/> instance.
    /// </summary>
    public static SkillsToolsOptions FromSkillsOptions(SkillsOptions options)
    {
