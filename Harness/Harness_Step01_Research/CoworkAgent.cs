...
public class CoworkAgent
{
    ...
    {
        var endpoint = configuration["Anthropic:EndPoint"]
            ?? throw new InvalidOperationException("配置项 'Anthropic:EndPoint' 未找到");
        var apiKey = configuration["Anthropic:ApiKey"]
            ?? throw new InvalidOperationException("配置项 'Anthropic:ApiKey' 未找到");
        var modelId = configuration["Anthropic:ModelId"]
            ?? throw new InvalidOperationException("配置项 'Anthropic:ModelId' 未找到");
        ...
        AIAgent agent =
            ...
            .AsIChatClient(modelId, MaxOutputTokens)
